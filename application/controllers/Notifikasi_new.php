...
class Notifikasi_new extends CI_Controller
{
    ...
    public function index()
    {
        ...
        if (!empty($pengaturan)) {
            ...
            foreach ($pengaturan as $setting) {
                ...
                $this->notifikasi_model->update_status_pengaturan($setting['id'], 0);
...
Pesan ini dikirim secara otomatis oleh sistem',
                ...
                // Hapus pengaturan setelah mengirimkan notifikasi
                $this->notifikasi_model->hapus_pengaturan_notifikasi($setting['id']);
            }
        } else {
    ...
    //                 // Setelah notifikasi dikirim, ubah status aktif menjadi 0
    //                 $this->notifikasi_model->update_status_pengaturan($pengaturan['id'], 0);
    //             }
    //         } else {
    //             echo 'Tidak ada pengaturan notifikasi aktif untuk waktu ini.';
    //         }
