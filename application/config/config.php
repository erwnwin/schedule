...
|
*/
// $config['base_url'] = 'http://localhost:8080/e-schedule.co.id/';
// $config['base_url'] = 'https://e-schedule.winartcode.my.id/';
...
|
*/
$config['enable_query_strings'] = FALSE; // Nama parameter query string untuk halaman
